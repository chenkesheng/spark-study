...
/**
 * @Author: cks
 * @Date: Created by 2019/8/9 14:15
 * @Package: cn.spark.core
 * @Description:
 */
...
//        saveAsTextFile();
    ...
    private static void reduce() {
        SparkConf conf = new SparkConf().setAppName("ActionOperate").setMaster("local");
    ...
    private static void collect(){
        ...
        // 使用map操作将集合中所有数字乘以2
        JavaRDD<Integer> doubleNumbers = numbers.map((Function<Integer, Integer>) v1 -> v1 * 2);
        /**
    ...
    private static void saveAsTextFile() {
        ...
        doubleNumbers.saveAsTextFile("hdfs://192.168.88.160:9000/double_number.txt");
