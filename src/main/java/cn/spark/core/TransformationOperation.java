...
/**
 * @Author: cks
 * @Date: Created by 2019/8/9 8:51
 * @Package: cn.spark.core
 * @Description: transformation操作实战
 */
...
//        join();
    ...
    private static void map() {
         ...
         * 并行化集合创建初始RDD
         */
        JavaRDD<Integer> numberRD = sc.parallelize(numbers);
        /**
         ...
         * 		// 所有新的元素就会组成一个新的RDD
         */
        JavaRDD<Integer> multipleNumberRDD = numberRD.map(new Function<Integer, Integer>() {
    ...
    private static void sortByKey() {
        ...
        // 打印sortedScored RDD
        sortedScores.foreach((VoidFunction<Tuple2<Integer, String>>) t -> System.out.println(t._1 + ": " + t._2));
    ...
    private static void join() {
        ...
        studentScores.foreach(
                (VoidFunction<Tuple2<Integer, Tuple2<String, Integer>>>) t -> {
    ...
    private static void cogroup() {
        ...
        studentScores.foreach(
                ...
                (VoidFunction<Tuple2<Integer, Tuple2<Iterable<String>, Iterable<Integer>>>>) t -> {
                    System.out.println("student id: " + t._1);
                    System.out.println("student name: " + t._2._1);
                    System.out.println("student score: " + t._2._2);
                    System.out.println("===============================");
